...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  },
  {
    ...
    why: 'The active region failed and traffic has not landed on the next one yet. Failover takes time, and requests arriving in that gap have nowhere to go — which is why failover is never truly free.',
    category: 'failure',
    aliases: ['region-down'],
    see: ['region', 'crashed'],
  },
